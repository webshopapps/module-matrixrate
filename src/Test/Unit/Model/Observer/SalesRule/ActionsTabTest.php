 ...
 */
namespace WebShopApps\MatrixRate\Test\Unit\Model\Observer\SalesRule;

use WebShopApps\MatrixRate\Model\SalesRule\Rule;

class ActionsTabTest extends \PHPUnit_Framework_TestCase
{
    /**
     * @var \WebShopApps\MatrixRate\Model\Observer\SalesRule\ActionsTab
     */
    protected $model;

    protected function setUp()
    {
        $this->model = new \WebShopApps\MatrixRate\Model\Observer\SalesRule\ActionsTab();
    }
